...
description: "类加载机制\r >类加载的过程包括了加载、验证、准备、解析、初始化五个阶段。在这五个阶段中，加载、验证、准备和初始化这四个阶段发生的顺序是确定的，而解析阶段则不一定.\r 加载\r 类加载器并不需要等到某个类被“首次主动使用”时再加载它\r   任务:\r 通过一个类的全限定名来获取其定义的二进制字节流。\r ..."
tags: ["笔记", "JVM", "Java"]
category: "JVM"
draft: false
---

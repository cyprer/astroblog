---
title: "2025/3/24 刷题记录"
published: 2025-03-24
description: "2025/3/24刷题记录\r 问题一: 二叉搜索树中第K小的元素\r 给定一个二叉搜索树的根节点 root ，和一个整数 k ，请你设计一个算法查找其中第 k 个最小元素（从 1 开始计数）。\r \r 思路:\r \r 1. 二叉搜索树的中序遍历是升序序列,因此可以通过中序遍历得到第k小的元素    \r 2..."
tags: ["笔记", "数据结构", "算法", "刷题"]
category: "刷题日记"
draft: false
---

---
title: "2025/03/19刷题记录"
published: 2025-03-19
description: "2025/03/19刷题记录\r \r 问题1: 两两交换链表中的节点\r 给定一个链表，两两交换其中相邻的节点，并返回交换后的链表的头节点。\r \r 思路1: 递归  \r     1.如果头节点为空或者头节点的下一个节点为空，则返回头节点。  \r     2.否则，将头节点的下一个节点作为新的头节点，将头..."
tags: ["笔记", "数据结构", "算法", "刷题"]
category: "刷题日记"
draft: false
---

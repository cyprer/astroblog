...
description: "2025/3/27刷题记录\r 问题1: 岛屿数量\r > 给你一个由 '1'（陆地）和 '0'（水）组成的的二维网格，请你计算网格中岛屿的数量。\r > 岛屿总是被水包围，并且每座岛屿只能由水平方向和/或竖直方向上相邻的陆地连接形成。\r > 此外，你可以假设该网格的四条边均被水包围。\r 思路1: 深度优..."
tags: ["笔记", "数据结构", "算法", "刷题"]
category: "刷题日记"
draft: false
---

---
title: "2025年3月10日刷题记录"
published: 2025-03-10
description: "2025年3月10日刷题记录\r 问题1: k美丽值\r 一个整数 num 的 k 美丽值定义为 num 中符合以下条件的 子字符串 数目：\r \r 子字符串长度为 k 。\r \r 子字符串能整除 num 。\r \r 给你整数 num 和 k ，请你返回 num 的 k 美丽值。\r \r 注意：\r \r 允许有 ..."
tags: ["笔记", "数据结构", "算法", "刷题"]
category: "刷题日记"
draft: false
---

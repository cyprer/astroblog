...
description: "2025/3/31刷题记录\r 问题1: 课程表\r 你这个学期必须选修 numCourses 门课程，记为 0 到 numCourses 1 。\r \r 在选修某些课程之前需要一些先修课程。 先修课程按数组 prerequisites 给出，其中 prerequisites[i] = [ai, bi] ..."
tags: ["笔记", "数据结构", "算法", "刷题"]
category: "刷题日记"
draft: false
---

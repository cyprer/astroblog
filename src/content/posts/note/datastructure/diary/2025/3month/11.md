---
title: "2025年3月11日刷题记录"
published: 2025-03-11
description: "2025年3月11日刷题记录\r 问题1: 三数之和\r 给你一个整数数组 nums ，判断是否存在三元组 [nums[i], nums[j], nums[k]] 满足 i != j、i != k 且 j != k ，同时还满足 nums[i] + nums[j] + nums[k] == 0 。请你返..."
tags: ["笔记", "数据结构", "算法", "刷题"]
category: "刷题日记"
draft: false
---

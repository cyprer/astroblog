...
description: "2025/4/5刷题记录\r 问题1:搜素二维数组\r 给你一个满足下述两条属性的 m x n 整数矩阵：\r \r 每行中的整数从左到右按非严格递增顺序排列。\r 每行的第一个整数大于前一行的最后一个整数。\r 给你一个整数 target ，如果 target 在矩阵中，返回 true ；否则，返回 fals..."
tags: ["笔记", "数据结构", "算法", "刷题"]
category: "刷题日记"
draft: false
---

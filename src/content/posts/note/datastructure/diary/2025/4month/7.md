...
description: "2025/4/7刷题记录\r \r 问题一: 最小栈\r   设计一个支持 push ，pop ，top 操作，并能在常数时间内检索到最小元素的栈。\r \r 实现 MinStack 类:\r \r MinStack() 初始化堆栈对象。\r void push(int val) 将元素val推入堆栈。\r void..."
tags: ["笔记", "数据结构", "算法", "刷题"]
category: "刷题日记"
draft: false
---

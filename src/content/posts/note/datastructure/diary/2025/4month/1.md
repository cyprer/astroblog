...
description: "2025/4/1刷题记录\r 问题1: 子集\r > 给定一组不含重复元素的整数数组 nums，返回该数组所有可能的子集（幂集）。\r > 说明：解集不能包含重复的子集。\r \r 思路:\r 对于输入的 nums，考虑每个 nums[i] 是选还是不选，由此组合出 2^n个不同的子集。\r \r dfs 中的 i..."
tags: ["笔记", "数据结构", "算法", "刷题"]
category: "刷题日记"
draft: false
---

...
description: "2025/4/9刷题记录\r \r 问题1: 数组中第K个最大元素\r \r 给定整数数组  和整数 ，请返回数组中第  个最大的元素。\r \r 请注意，你需要找的是数组排序后的第  个最大的元素，而不是第  个不同的元素。\r \r 示例:\r 输入: [3,2,3,1,2,4,5,5,6], k = 4  \r ..."
tags: ["笔记", "数据结构", "算法", "刷题"]
category: "刷题日记"
draft: false
---

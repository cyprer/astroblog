---
title: "RISC-V 指令集及相关概念总结"
published: 2025-03-11
description: "RISC-V 指令集及相关概念总结\r \r 一、基础指令\r \r （一）加法与减法指令\r 加法指令：  \r   将寄存器和的值相加，结果存入寄存器。\r \r 减法指令：  \r   将寄存器的值减去的值，结果存入寄存器。\r \r （二）立即数加法指令\r 立即数加法：  \r   将寄存器的值与立即数相加，结果存..."
tags: ["笔记", "计组", "CS"]
category: "计算机组成原理"
draft: false
---
